...
\setfootline{Careful with That Axe, Eugene}
\begin{frame}[t]
...
\setfootline{Set the Controls for the Heart of the Sun}
\begin{frame}[t]
...
\setfootline{Another Brick in the Wall}
\begin{frame}[t]
